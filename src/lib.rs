...
pub fn init(boot_info: &'static BootInfo, memory_region: (u64, u64, u64)) {
    ...
    alloc::set_heap(
        boot_info.physical_memory_offset as usize + memory_region.1 as usize, 
        boot_info.physical_memory_offset as usize + memory_region.1 as usize + memory_region.0 as usize
    );
